        ...
        <div class="row">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="163" height="38" viewBox="0 0 163 38">
                            <g id="Logo" transform="translate(-260 -51)">
                                ...
                                <text id="Quickeat" transform="translate(320 77)" fill="#fff" font-size="20"
                                    ...
                                    <tspan x="0" y="0" font-size="30">Cafe</tspan>
                                    <tspan y="0" fill="#f29f05" font-size="30">R</tspan>
                                </text>
                            </g>
                        </svg>
                    </a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="menu">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="restaurants.html">Menu<i class="fa-solid fa-arrow-right"></i></a></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="menu contacts">
                    ...
                    <a href="mailto:quickeat@mail.net"><i class="fa-solid fa-envelope"></i>cafeRt@gmail.com</a>
                    <a href="callto:+14253261627"><i class="fa-solid fa-phone"></i>082849++</a>
                </div>
